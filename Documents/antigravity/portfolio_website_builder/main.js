document.addEventListener('DOMContentLoaded', () => {
  ...
  const scatterCardsRandomly = () => {
    try {
      ...
      const projW = 320;
      const projH = 160; // Styled height (slimmed for Trello style)
  ...
  const langData = {
    ko: {
      ...
      labels: {
        ...
        helper: "프로젝트를 자세히 확인하고 싶으시다면 각 카드의 '더 보기' 버튼을 눌러주세요.",
        canvasTitle: "캔버스",
        badgeTitle: "동적 포트폴리오",
    ...
    en: {
      ...
      labels: {
        ...
        lblDomain: "DOMAIN",
        valDomain: "PACKAGING & TEST",
        helper: "If you want to view project details, please click the 'Read More' button on each card.",
        canvasTitle: "Canvas",
